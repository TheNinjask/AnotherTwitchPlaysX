...
public class StringChatCommandsMod extends ATPXMod {
	...
	public StringChatCommandsMod() {
		...
		title.setForeground(Constants.TWITCH_THEME.font());
		...
		selectLabel.setForeground(Constants.TWITCH_THEME.font());
		...
		cmdLabel.setForeground(Constants.TWITCH_THEME.font());
		...
		respLabel.setForeground(Constants.TWITCH_THEME.font());
